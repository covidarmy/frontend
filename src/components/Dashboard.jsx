...
export const Dashboard = () =>{
    const cities = ["Mumbai", "Delhi", "Indore", "Bhopal", "Dehradun", "Agra", "Bengaluru", "Chandigarh"]
    const resources = ["All", "Oxygen", "Remdesivir", "Ventilator", "Beds", "Food", "Fabilflu", "Plasma", "Blood", "Tests"]
    return(
                ...
                <div className="grid rounded-lg grid-col-1 gap-4">
                    <div className='shadow-lg box-border h-auto w-100% p-6'>
                        <div className='flex ml-1'>
                            ...
                            <p className='text-strong ml-1 mt-0.5 font-bold'>Choose Your Location</p>
                        </div>
                        <div className="pt-2 ml-1 flex justify-start relative text-gray-600">
                            <input className="border-2 w-full relative w-400 border-gray-300 bg-white h-10 px-5 pr-16 rounded-lg text-sm focus:outline-none" type="search" name="search" placeholder="Search" />
                        ...
                        <div className=' mt-2 ml-1'>
                            <a className='hover:text-underline flex' style={{color: '#4F46EF'}}>Other locations <svg className='mt-1' width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M5 7.5L10 12.5L15 7.5" stroke="#4F46EF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg> </a>
                    ...
                    <div className='shadow-lg text-center box-border h-auto w-100% p-6'>
                        <div className='flex'>
                            <svg className='mt-0.5' width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M9 16.5C9 16.5 15 13.5 15 9V3.75L9 1.5L3 3.75V9C3 13.5 9 16.5 9 16.5Z" fill="#4F46EF"/>
                                <path d="M9 6V10" stroke="white" stroke-linecap="round" stroke-linejoin="round"/>
