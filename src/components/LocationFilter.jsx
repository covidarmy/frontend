...
export default function LocationFilter({ data }) {
  ...
  return (
    <div className="shadow-md bg-white box-border h-auto w-100  rounded-md p-6 border border-gray-200">
      ...
      <div className="ml-0 mt-2 flex items-center justify-start flex-wrap">
        {renderButtons()}
      </div>
