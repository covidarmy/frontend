        ...
        <nav>
          <div className="flex items-center justify-between w-full h-16 px-4 lg:px-20">
            ...
            <div className="hidden md:block sm:ml-20 sm:mr-0 space-x-4 justify-between lg:ml-20">
              <Link href="/">
                <a className="hover:bg-gray-700 text-gray focus:bg-red hover:text-white px-3 py-2 rounded-md text-sm font-medium transition-colors">
                  Home
                </a>
              </Link>
              <a
              ...
              <Link href="/disclaimer">
                <a className="hover:bg-gray-700 text-gray hover:text-white px-3 py-2 rounded-md text-sm font-medium transition-colors">
                  Disclaimer
                </a>
              </Link>
              <Link href="/about">
