...
const navigation = ["Home", "Share", "How it Works", "Blog", "Contact Us"]
...
export default function Navbar() {
  return (
    <div>
      <Disclosure as="nav" className="shadow-lg bg-white">
        {({ open }) => (
          <>
              ...
              <div className="flex flex-row row h-16 navbar">
                <div className="flex items-center justify-between lg:mx-20">
                  ...
                  <div className="hidden md:block">
                    <div className="sm:ml-20 sm:mr-0 space-x-4 justify-end lg:ml-20">
